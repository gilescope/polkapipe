...
pub extern "C" fn init(max_log_level: u32, enable_current_task: u32, cpu_rate_limit: u32) {
    crate::smol::init(max_log_level, enable_current_task, cpu_rate_limit)
}
...
pub extern "C" fn timer_finished(timer_id: u32) {
    crate::smol::timers::timer_finished(timer_id);
}
...
pub extern "C" fn connection_open_single_stream(connection_id: u32) {
    crate::smol::platform::connection_open_single_stream(connection_id);
}
...
pub extern "C" fn connection_open_multi_stream(
    ...
    crate::smol::platform::connection_open_multi_stream(connection_id, peer_id_ptr, peer_id_len)
}
...
pub extern "C" fn stream_message(connection_id: u32, stream_id: u32, ptr: u32, len: u32) {
    crate::smol::platform::stream_message(connection_id, stream_id, ptr, len)
}
...
pub extern "C" fn connection_stream_opened(connection_id: u32, stream_id: u32, outbound: u32) {
    crate::smol::platform::connection_stream_opened(connection_id, stream_id, outbound)
}
...
pub extern "C" fn connection_closed(connection_id: u32, ptr: u32, len: u32) {
    crate::smol::platform::connection_closed(connection_id, ptr, len)
}
...
pub extern "C" fn stream_closed(connection_id: u32, stream_id: u32) {
    crate::smol::platform::stream_closed(connection_id, stream_id)
}
